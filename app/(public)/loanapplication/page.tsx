...
// Loading fallback
function LoanApplicationLoading() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-white to-[#1D942C]/5">
      {/* Hero Section Skeleton */}
      <section className="relative py-20 bg-[#1D942C] overflow-hidden">
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="h-12 bg-white/20 rounded w-3/4 md:w-1/2 mx-auto mb-6"></div>
          <div className="h-8 bg-white/20 rounded w-1/2 md:w-1/3 mx-auto mb-2"></div>
...
export default function LoanApplicationPage() {
  return (
    <Suspense fallback={<LoanApplicationLoading />}>
